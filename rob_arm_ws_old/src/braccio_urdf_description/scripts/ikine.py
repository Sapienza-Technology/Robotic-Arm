...
xacro = ERobot.URDF("/home/alessio/ROS/Robotic-Arm/rob_arm_ws_old/src/braccio_urdf_description/urdf/braccio_urdf_edit.xacro")
print(xacro)
# we don't need urdf, importing the xacro works ok
urdf = ERobot.URDF("/home/alessio/ROS/Robotic-Arm/rob_arm_ws_old/src/braccio_urdf_description/urdf/braccio_urdf.urdf")
print(urdf)
