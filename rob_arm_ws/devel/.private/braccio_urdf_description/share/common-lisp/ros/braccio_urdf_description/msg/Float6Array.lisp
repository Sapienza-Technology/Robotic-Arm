...
(cl:in-package braccio_urdf_description-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Float6Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float6Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name braccio_urdf_description-msg:<Float6Array> is deprecated: use braccio_urdf_description-msg:Float6Array instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x1-val is deprecated.  Use braccio_urdf_description-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x2-val is deprecated.  Use braccio_urdf_description-msg:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'x3-val :lambda-list '(m))
(cl:defmethod x3-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x3-val is deprecated.  Use braccio_urdf_description-msg:x3 instead.")
  (x3 m))

(cl:ensure-generic-function 'x4-val :lambda-list '(m))
(cl:defmethod x4-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x4-val is deprecated.  Use braccio_urdf_description-msg:x4 instead.")
  (x4 m))

(cl:ensure-generic-function 'x5-val :lambda-list '(m))
(cl:defmethod x5-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x5-val is deprecated.  Use braccio_urdf_description-msg:x5 instead.")
  (x5 m))

(cl:ensure-generic-function 'x6-val :lambda-list '(m))
(cl:defmethod x6-val ((m <Float6Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader braccio_urdf_description-msg:x6-val is deprecated.  Use braccio_urdf_description-msg:x6 instead.")
  (x6 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Float6Array>)))
  ...
  "braccio_urdf_description/Float6Array")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Float6Array)))
  "Returns string type for a message object of type 'Float6Array"
  "braccio_urdf_description/Float6Array")
